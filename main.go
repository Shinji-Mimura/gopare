...
func main() {
	...
	if _, err := strconv.ParseInt(os.Args[2], 10, 64); err != nil {
		log.Fatal("Second parameter must be a positive number!\n")
		os.Exit(1)
	}
	...
	barsize := (cf.GetBarSize(len(files)))
